function drawStats(){
  ...
  var statColors = {};
  statColors.charm = "#339933";
  statColors.fitness = "#333399";
  statColors.smarts = "#999933";
  statColors.style = "#993399";
  statColors.stress = "#993333";
  ...
  var innerPolygonColor = statColors.charm;
  ...
  function redraw(){
    ...
    for(var i = 0; i < statOrder.length+1; i ++){
      ...
      x = polygonX+Math.cos(vertices[index].radians)*(vertices[index].distTotal*stat/30);
      y = polygonY+Math.sin(vertices[index].radians)*(vertices[index].distTotal*stat/30);
